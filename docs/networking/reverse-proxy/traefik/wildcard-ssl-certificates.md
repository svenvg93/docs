...
1. Replace `<service-name>` with a unique name for your service
2. `${DOMAIN}` should be set in your `.env` file to your main domain
3. Replace `<port>` with the port your container exposes internally
