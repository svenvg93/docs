...
Learn how to automate routine system maintenance tasks like updating packages and rebooting, while organizing your Ansible project using **roles** and **handlers** for better structure and reuse.
...
```yaml title="system-maintenance.yml"
