...
- Analytics
date: 2025-01-29
description: Learn how to self-host your website analytics using Umami, a privacy-focused
  and open-source analytics platform.
draft: false
tags:
- umami
- web analytics
...
Setting up the Cloudflare tunnel is out of scope for this post. Check out this [post] if you want to know how to set it up.
...
Now you can add the Website ID to your website, according to their instructions. In this example we add it to a [Jekyll blog with the Chripy theme].
...
[post]: ../cloudflare-tunnel-secure
[jekyll-blog-with-the-chripy-theme]: ../jekyll-chirpy-cloudflare-pages
