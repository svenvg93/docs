...
- CI/CD
date: 2025-01-31
description: A step-by-step guide on automating the deployment of your blog using
  GitHub Actions for continuous publishing.
draft: false
tags:
- github actions
- jekyll
...
```yaml title="pages-deployment.yaml"
...
[jekyll-with-cloudflare-pages]: ../jekyll-chirpy-blog-on-cloudflare-pages/
