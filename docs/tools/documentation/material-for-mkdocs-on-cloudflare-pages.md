...
1.	Go to my [mkdocs-material-starter] repository.
...
Material for MkDocs offers a wide range of layout and customization options for your pages. You can explore the [Material for MkDocs Reference Guide] for additional styling and layout options.
...
[mkdocs-material-starter]: https://github.com/svenvg93/mkdocs-material-starter
