...
1.	Go to my [zensical-starter-template] repository.
...
Zensical offers a wide range of layout and customization options for your pages. You can explore the [Zensical Reference Guide] for additional styling and layout options.
...
[zensical-starter-template]: https://github.com/svenvg93/zensical-starter-template
[cloudflare dashboard]: https://dash.cloudflare.com/
[zensical-reference-guide]: https://zensical.org/docs/setup/basics/
